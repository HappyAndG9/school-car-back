    ...
    public static void main(String[] args) {
        ...
        FastAutoGenerator.create("jdbc:mysql://localhost:3306/school_car", "root", "password")
                ...
                .packageConfig(builder -> {
                    builder.parent("happy.schoolcarback") // 设置父包名
                ...
                .strategyConfig(builder -> {
                    builder.addInclude(  		  //"administrator",
//                                    "announcement",
//                                    "charging_pile",
//                                    "record",
//                                    "feedback"
...
//                            "charging_pile_area","parking_area"
                            ...
                            .addTableFills(
                                    ...
                                    new Column("publish_time",FieldFill.INSERT),
                                    new Column("build_time",FieldFill.INSERT),
                                    new Column("transit_time",FieldFill.INSERT),
