package happy.schoolcarback.security.filter;


import happy.schoolcarback.security.service.MyUserDetailsService;
import happy.schoolcarback.security.token.TokenParameters;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        //0.获取请求路径,如果是放行的资源，不做token验证
//        String requestUrl = request.getRequestURI();
//        if (isResourcesPath(requestUrl)){
